...
const SYSTEM_INSTRUCTIONS =
  ...
  "\n\n## ツール呼び出しの大原則\n" +
  "ユーザーが明示的に指示したツールのみ使うこと。特に買い物リスト操作（add_shopping_items・complete_all_shopping）とデバイス操作は、ユーザーが「買い物リストに追加して」「〜をつけて」など明確に依頼した場合のみ実行すること。会話の文脈から商品名らしき単語が出てきても、買い物リストへの追加を勝手に行わないこと。" +
  "\n\n## ツールのリスク分類と確認ルール\n" +
